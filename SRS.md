...
Cloud-Based Services. _International Journal of Advanced Computer
Science and Applications (IJACSA), 12_(1), 402–409.
doi:10.14569/IJACSA.2021.0120152

Abusair, S., Khan, R. Z., & Mian, M. A. (2020). Smart Campus Mobility: A
Conceptual Model for Ride-Sharing and Parking Management. _2020 5th
International Conference on Computing, Communication and Security
(ICCCS)_, 1–6. doi:10.1109/ICCCS49678.2020.9277569

Raghunandan, N., & Kalaimani, R. (2018). Efficient Parking Management
System Using Cloud and IoT. _International Journal of Engineering &
Technology_, 7(2.33), 287–290. doi:10.14419/ijet.v7i2.33.14393

Li, C., & Zheng, S. (2022). Smart Transportation Systems for University
Campuses: Integrating Ride-Sharing and Parking Solutions. _IEEE Access,
10_, 114327–114339. doi:10.1109/ACCESS.2022.3212984

Wang, X., & Wang, S. (2019). Optimization of University Campus Parking
Based on Real-Time Data. _Journal of Urban Transport_, 25(4), 89–97.
doi:10.1007/s12469-019-00255-6

OpenAI. (2024). _Campus Ride-Sharing & Parking User Survey Form_.
Retrieved from  
...
| REQ_P005 | The system shall process up to 100,000 ride-sharing and parking transactions daily with a max latency of 500ms. | High |
| REQ_P006 | User dashboards and trip/parking history shall load within 2 seconds under typical network conditions (< 150ms latency) and backend response time not exceeding 800ms under typical traffic condition. | Medium |
...
| REQ_P013 | Real-time ride and parking notifications shall have a max update period of 1s under all conditions. | High |
...
| REQ_UR002 | The interface shall display relevant real-time updates such as parking availability and ride offers with a max update period of 1s under all conditions. | Medium |
...
| REQ_UR005 | The interface shall offer a clean, responsive, and intuitive design to minimize user confusion and cognitive load such that each task shall have no more than 2 support tickets during beta testing. | High |
...
| REQ_SI004 | Notification Service | Enables admins to create notifications for all roles and enables riders to send report alerts to admins. | API integration with email/SMS (e.g., SendGrid, Twilio) |
...
<td style="text-align: left;">The system shall support HTTP/HTTPS (TLS1.2+)
...
|----|----|----|----|
| Requirement ID | Description | Priority | Author |
| REQ_SRA007 | The system shall handle up to 5000 concurrent users and up to 100 transactions per second without crashing. | High | Francis Wong Wei Hou |
...
<tr>
<td>REQ_SRA011</td>
<td>The system shall implement secure user authentication (OAuth2.0 and JWT) to prevent
